...
namespace DigitalStorage.Components
{
    ...
    public class CompVirtualIngredient : ThingComp
    {
        ...
        private bool reservedThingPositionOnly = false; // 预留物品是否仅作为位置提供者
        ...
        public bool ReservedThingPositionOnly => reservedThingPositionOnly;
        ...
        public void SetFromReserved(bool value, Thing reservedThing = null)
        {
            ...
            this.reservedThingPositionOnly = false;
        }

        public void SetReservedThingPositionOnly(bool value, Thing reservedThing = null)
        {
            isFromReserved = false;
            this.reservedThingPositionOnly = value;
            this.reservedThing = reservedThing;
        }
        ...
        public override void PostExposeData()
        {
            ...
            Scribe_Values.Look(ref reservedThingPositionOnly, "reservedThingPositionOnly", false);
